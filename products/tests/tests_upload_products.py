...
class CSVFileHandlingTests(TestCase):
    ...
    def test_malformed_csv(self):
        ...
        try:
            ...
            self.assertTrue(
                'CSV error' in error_msg or 'Missing columns' in error_msg
            )
        finally:
            os.remove(csv_path)
...
class HeaderValidationTests(TestCase):
    ...
    def test_missing_name_column(self):
        ...
        rows = [{'category': 'NYSC KIT', 'price': '5000', 'description': 'Test', 'type': 'kakhi'}]
    ...
    def test_missing_category_column(self):
        ...
        rows = [{'name': 'Test', 'price': '5000', 'description': 'Test', 'type': 'kakhi'}]
    ...
    def test_missing_price_column(self):
        ...
        rows = [{'name': 'Test', 'category': 'NYSC KIT', 'description': 'Test', 'type': 'kakhi'}]
    ...
    def test_missing_type_column_for_nysc_kit(self):
        ...
        rows = [{'name': 'Test', 'category': 'NYSC KIT', 'price': '5000', 'description': 'Test'}]
    ...
    def test_missing_church_column_for_church(self):
        ...
        headers = ['name', 'category', 'price', 'description']
        rows = [{'name': 'Test', 'category': 'CHURCH PROG', 'price': '5000', 'description': 'Test'}]
...
class CSVDuplicateDetectionTests(TestCase):
    ...
    def test_multiple_duplicates(self):
        ...
        headers = ['name', 'category', 'price', 'description', 'type']
        rows = [
            {'name': 'Product A', 'category': 'NYSC KIT', 'price': '5000', 'description': 'Test', 'type': 'kakhi'},
            {'name': 'Product B', 'category': 'NYSC KIT', 'price': '6000', 'description': 'Test', 'type': 'vest'},
            {'name': 'Product A', 'category': 'NYSC KIT', 'price': '7000', 'description': 'Test', 'type': 'kakhi'},  # Duplicate
            {'name': 'Product B', 'category': 'NYSC KIT', 'price': '8000', 'description': 'Test', 'type': 'vest'},  # Duplicate
        ]
    ...
    def test_case_sensitive_duplicate_detection(self):
        ...
        headers = ['name', 'category', 'price', 'description', 'type']
        rows = [
            {'name': 'Quality Nysc Kakhi', 'category': 'NYSC KIT', 'price': '5000', 'description': 'Test', 'type': 'kakhi'},
            {'name': 'quality nysc kakhi', 'category': 'NYSC KIT', 'price': '6000', 'description': 'Test', 'type': 'kakhi'},  # Different case
        ]
        ...
        try:
            ...
            self.assertEqual(NyscKit.objects.filter(name='Quality Nysc Kakhi').count(), 1)
    ...
    def test_no_duplicates(self):
        ...
        rows = [
            {'name': 'Quality Nysc Kakhi', 'category': 'NYSC KIT', 'price': '5000', 'description': 'Test', 'type': 'kakhi'},
            {'name': 'Quality Nysc Vest', 'category': 'NYSC KIT', 'price': '3000', 'description': 'Test', 'type': 'vest'},
            {'name': 'Quality Nysc Cap', 'category': 'NYSC KIT', 'price': '2500', 'description': 'Test', 'type': 'cap'},
        ]
...
class CategoryValidationTests(TestCase):
    ...
    def test_valid_category_names(self):
        ...
        valid_categories = ['NYSC KIT', 'NYSC TOUR', 'CHURCH PROG']
...
class CloudinaryIntegrationTests(TestCase):
    ...
    def test_extract_public_id_with_transformations(self):
        ...
        url = 'https://res.cloudinary.com/demo/image/upload/w_100,h_100,c_fill/sample.jpg'
        public_id = command._extract_cloudinary_public_id(url)
...
class TransactionHandlingTests(TestCase):
    ...
    def test_rollback_on_error(self):
        ...
        try:
            ...
            self.assertEqual(NyscKit.objects.filter(name='Quality Nysc Kakhi').count(), 1)
            self.assertEqual(NyscKit.objects.filter(name='Quality Nysc Vest').count(), 0)
        finally:
            os.remove(csv_path)
    ...
    def test_partial_success(self):
        ...
        rows = [
            {'name': 'Quality Nysc Kakhi', 'category': 'NYSC KIT', 'price': '5000', 'description': 'Test', 'type': 'kakhi'},
            {'name': 'Invalid Product', 'category': 'NYSC KIT', 'price': '3000', 'description': 'Test', 'type': 'vest'},
            {'name': 'Quality Nysc Cap', 'category': 'NYSC KIT', 'price': '2500', 'description': 'Test', 'type': 'cap'},
        ]
...
class OutputAndSummaryTests(TestCase):
    ...
    def test_dry_run_message(self):
        ...
        headers = ['name', 'category', 'price', 'description', 'type']
        rows = [{'name': 'Quality Nysc Kakhi', 'category': 'NYSC KIT', 'price': '5000', 'description': 'Test', 'type': 'kakhi'}]
