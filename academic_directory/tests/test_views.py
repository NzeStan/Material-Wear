...
class TestUniversityViewSet:
    ...
    def test_list_universities_admin(self, admin_api_client, university, multiple_universities):
    ...
    def test_list_excludes_inactive(self, admin_api_client, university, inactive_university):
...
class TestFacultyViewSet:
    ...
    def test_list_faculties_filter_by_university(self, admin_api_client, faculty, university):
...
class TestDepartmentViewSet:
    ...
    def test_list_departments_filter_by_faculty(self, admin_api_client, department, faculty):
...
class TestRepresentativeViewSet:
    ...
    def test_list_representatives_admin(self, admin_api_client, class_rep, dept_president):
    ...
    def test_list_filter_by_verification_status(self, admin_api_client, class_rep, verified_representative):
    ...
    def test_retrieve_representative(self, admin_api_client, class_rep, program_duration):
    ...
    def test_verify_single(self, admin_api_client, class_rep):
        ...
        url = reverse('academic_directory:representative-verify-single', args=[class_rep.id])
    ...
    def test_dispute_single(self, admin_api_client, verified_representative):
        ...
        url = reverse('academic_directory:representative-dispute-single', args=[verified_representative.id])
        response = admin_api_client.post(url)
        assert response.status_code == status.HTTP_200_OK
        assert response.data['success'] is True
...
class TestPublicSubmissionView:
    ...
    def test_submit_single_entry(self, api_client, department, program_duration):
        ...
        with patch('jmw.background_utils.send_new_submission_email_async'):
    ...
    def test_submit_handles_duplicates(self, api_client, class_rep, department, program_duration):
...
class TestDashboardView:
    ...
    def test_dashboard_returns_stats(self, admin_api_client, university, faculty, department, class_rep):
...
class TestNotificationViewSet:
    ...
    def test_mark_single_as_read(self, admin_api_client, unread_notification):
        ...
        url = reverse('academic_directory:notification-mark-read', args=[unread_notification.id])
        response = admin_api_client.post(url)
        assert response.status_code == status.HTTP_200_OK
        assert response.data['success'] is True
...
class TestViewSecuritySQLInjection:
    ...
    def test_search_sql_injection(self, admin_api_client, class_rep):
        ...
        response = admin_api_client.get(url, {'search': "'; DROP TABLE representatives; --"})
    ...
    def test_filter_sql_injection(self, admin_api_client):
        ...
        url = reverse('academic_directory:representative-list')
        response = admin_api_client.get(url, {'role': "'; DROP TABLE representatives; --"})
