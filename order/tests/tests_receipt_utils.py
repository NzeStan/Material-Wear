...
class GenerateAndStorePaymentReceiptTests(TestCase):
    ...
    def test_generate_and_store_payment_receipt_success(self, mock_generate, mock_upload):
    ...
    @patch('order.receipt_utils.upload_pdf_to_cloudinary')
    @patch('order.receipt_utils.generate_payment_receipt_pdf')
    def test_generate_and_store_payment_receipt_upload_failure(self, mock_generate, mock_upload):
    ...
    @patch('order.receipt_utils.upload_pdf_to_cloudinary')
    @patch('order.receipt_utils.generate_payment_receipt_pdf')
    def test_generate_and_store_payment_receipt_error_handling(self, mock_generate, mock_upload):
